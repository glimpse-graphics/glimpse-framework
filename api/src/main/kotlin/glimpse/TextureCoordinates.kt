...
data class TextureCoordinates(val u: Float, val v: Float) {
	...
	companion object {
		 ...
		 */
		val BOTTOM_LEFT = TextureCoordinates(0f, 0f)

		/**
		 * Bottom right corner of a texture.
		 */
		val BOTTOM_RIGHT = TextureCoordinates(1f, 0f)

		/**
		 * Top left corner of a texture.
		 */
		val TOP_LEFT = TextureCoordinates(0f, 1f)

		/**
		 * Top right corner of a texture.
		 */
		val TOP_RIGHT = TextureCoordinates(1f, 1f)
	}
